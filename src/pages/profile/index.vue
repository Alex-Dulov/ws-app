  ...
  <div class="profile">
    <div class="container p-4 rounded-2 bg-info bg-opacity-10">
        ...
        <div class="col-md-9">
          ...
          >
            <textarea
              ...
              v-model="message"
            ></textarea>
            <button class="btn btn-outline-primary" type="submit" id="sendPost">
              Создать пост
            </button>
          </form>
        </div>
      ...
      <div class="row">
        ...
        >
          <div
            class="container p-4 rounded-2 bg-info bg-opacity-10 mb-4"
...
export default defineComponent({
  name: "Profile",
  props: ["userName", "aboutMessage", "userId"],
  data() {
    return {
      myPosts: [],
      message: "",
